...
.calendar .vc-weekday {
  @apply text-slate-400 rounded-md w-8 font-normal text-[0.8rem];
}
.calendar .vc-weeks {
  @apply w-full space-y-2 flex flex-col [&>_div]:grid [&>_div]:grid-cols-7;
}
.calendar .vc-day:has(.vc-highlights) {
  @apply bg-slate-100 first:rounded-l-md last:rounded-r-md overflow-hidden;
}
...
.calendar .vc-highlight-content-outline {
  @apply bg-slate-900 text-slate-50 hover:bg-slate-900 hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50;
}
...
.vc-time-picker.vc-attached {
  @apply border-t border-solid border-slate-100 mt-2;
}
.vc-time-picker > * + * {
  @apply mt-1;
}
...
.vc-time-select-group {
  @apply inline-flex items-center px-1 rounded-md bg-slate-50 border border-solid border-slate-100;
}
.vc-time-select-group .vc-base-icon {
  @apply mr-1 text-slate-900 stroke-slate-900;
}
.vc-time-select-group select {
  @apply bg-slate-50 p-1 appearance-none outline-none text-center;
}
.vc-time-weekday {
  @apply text-slate-500 tracking-wide;
}
.vc-time-month {
  @apply text-slate-900 ml-2;
}
.vc-time-day {
  @apply text-slate-900 ml-1;
}
.vc-time-year {
